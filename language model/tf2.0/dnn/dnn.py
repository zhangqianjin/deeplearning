...
class dnn_model(Model):
    def __init__(self, n_mid, embedding_dim, hidden_size, batch_size, num_interest, seq_len=256, neg_num=10, add_pos=True):
        ...
        self.mid_embeddings_var = tf.Variable(tf.random.uniform(shape=[n_mid,embedding_dim],  minval=-1.0/math.sqrt(self.embedding_dim), maxval=1/math.sqrt(self.embedding_dim)))
