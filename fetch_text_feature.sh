...
#参考 class BertForSequenceClassification(PreTrainedBertModel)  https://github.com/huggingface/pytorch-transformers/blob/3ba5470eb85464df62f324bea88e20da234c423f/pytorch_pretrained_bert/modeling.py#L867
